...
alias doclog="docker logs -f"
alias docps="docker ps -a | less -S"
alias docrm="docker rm -fv"
alias docrmall="docker ps -aq | xargs -r docker rm -fv"
alias docrmi="docker rmi -f"
alias doccln="docker container prune -f"
alias docimgcln="docker image prune -f"
